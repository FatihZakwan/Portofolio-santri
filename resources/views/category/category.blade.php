...
<body class="antialiased relative min-h-screen text-slate-800">
    ...
    <div class="fixed inset-0 w-full h-full overflow-hidden pointer-events-none bg-white">
        <div class="gradient-blob bg-purple-600 w-[500px] h-[500px] top-0 left-0" id="blob1"></div>
        ...
        <div class="gradient-blob bg-pink-400 w-[350px] h-[350px] bottom-0 right-0" id="blob4"></div>
    </div>
    ...
    <header class="relative pt-40 pb-16 px-4 text-center z-10">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                @foreach(['Web Development', 'Mobile Apps', 'IoT System'] as $sub)
                    <a href="#" class="glass-pill px-6 py-2.5 rounded-full text-sm font-bold text-slate-600 hover:bg-white hover:text-orange-600 hover:scale-105 transition-all duration-300">
                        {{ $sub }}
                    </a>
                @endforeach
            </div>
            ...
            <div class="mb-24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($topProjects as $index => $top)
                        <a href="/detail-project" class="group relative rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 block h-[450px] border border-slate-100">
